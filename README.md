-hover-color: #ffffff; /* Similar to --nav-hover-color, this color is applied to dropdown navigation links when they are hovered over. */
}
...
/* Target the gap between the Experience and Skills sections specifically */
#resume .row > .col-lg-6 {
